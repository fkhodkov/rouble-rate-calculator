...
public sealed interface PeriodAverage permits PeriodAverage.NoData, PeriodAverage.Data {
  ...
  static PeriodAverage data(Period period, BigDecimal value, int observations,
  ...
  record Data(Period period, BigDecimal value, int observations,
              LocalDate firstDate, LocalDate lastDate) implements PeriodAverage {}
}
