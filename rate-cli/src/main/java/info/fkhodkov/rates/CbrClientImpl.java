...
final class CbrClientImpl implements CbrClient {
  ...
  CbrClientImpl() throws GeneralSecurityException, IOException {
  ...
  @Override
  public InputStream downloadDailyRates() throws IOException, InterruptedException {
  ...
  private static SSLContext cbrSslContext() throws GeneralSecurityException, IOException {
    ...
    try (var input = CbrClientImpl.class.getResourceAsStream(
